...
impl PyLazyFrame {
    ...
    #[pyo3(signature = (
        ...
        maintain_order, cloud_options, credential_provider, retries, sink_options, engine
    ))]
    fn sink_parquet(
        &self,
        py: Python,
    ...
    #[pyo3(signature = (target, compression, maintain_order, cloud_options, credential_provider, retries, sink_options, engine))]
    fn sink_ipc(
        &self,
        py: Python,
        target: SinkTarget,
    ...
    #[pyo3(signature = (
        ...
        quote_style, maintain_order, cloud_options, credential_provider, retries, sink_options, engine,
    ))]
    fn sink_csv(
        &self,
        py: Python,
    ...
    #[pyo3(signature = (target, maintain_order, cloud_options, credential_provider, retries, sink_options, engine))]
    fn sink_json(
        &self,
        py: Python,
        target: SinkTarget,
