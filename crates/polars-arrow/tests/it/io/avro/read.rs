...
use avro_rs::{Codec, Days, Decimal, Duration, Millis, Months, Schema as AvroSchema, Writer};
...
"#;
    ...
    let schema = Schema::from(vec![
        ...
        Field::new(
            "enum",
            ArrowDataType::Dictionary(i32::KEY_TYPE, Box::new(ArrowDataType::Utf8), false),
            false,
        ),
        Field::new("decimal", ArrowDataType::Decimal(18, 5), false),
        Field::new(
            "nullable_struct",
            ArrowDataType::Struct(vec![Field::new("e", ArrowDataType::Float64, false)]),
            true,
