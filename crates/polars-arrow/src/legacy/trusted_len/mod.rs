...
{}
unsafe impl TrustedLen for crate::array::Utf8ValuesIter<'_, i64> {}
unsafe impl TrustedLen for crate::array::BinaryValueIter<'_, i64> {}
unsafe impl TrustedLen for crate::array::ListValuesIter<'_, i64> {}
unsafe impl TrustedLen for crate::array::ArrayValuesIter<'_, FixedSizeListArray> {}
