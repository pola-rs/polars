...
fn push(
    ...
    match min.data_type().to_logical_type() {
        ...
        UInt32 => match physical_type {
            ...
            other => polars_bail!(nyi = "cannot decode UInt32 type from parquet type {other:?}"),
        },
        ...
        Date64 => match physical_type {
            ...
            other => polars_bail!(nyi = "cannot decode Date64 type from parquet type {other:?}"),
        },
        ...
        Decimal(_, _) => match physical_type {
            ...
            ParquetPhysicalType::FixedLenByteArray(n) if *n > 16 => polars_bail!(
                nyi = "cannot decode Decimal128 type from Fixed Size Byte Array of len {n:?}"
            ),
        ...
        Decimal256(_, _) => match physical_type {
            ...
            ParquetPhysicalType::FixedLenByteArray(n) if *n > 32 => polars_bail!(
                nyi = "cannot decode Decimal256 type from Fixed Size Byte Array of len {n:?}"
            ),
