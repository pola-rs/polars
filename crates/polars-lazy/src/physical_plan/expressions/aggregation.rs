...
use crate::prelude::AggState::{AggregatedFlat, AggregatedList};
use crate::prelude::*;
        ...
        let out = unsafe {
            match self.agg_type {
                GroupByMethod::Min => {
                    ...
                    AggregatedFlat(rename_series(agg_s, &keep_name))
                },
                GroupByMethod::Max => {
                    check_null_prop!();
                    let (s, groups) = ac.get_final_aggregation();
                ...
                GroupByMethod::Groups => {
                    ...
                    AggregatedFlat(column.into_series())
                },
