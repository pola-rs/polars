...
pub mod builder {
    ...
    pub struct BatchFnReaderBuilder {
        ...
        pub execution_state: parking_lot::Mutex<Option<StreamingExecutionState>>,
    }
    ...
    impl FileReaderBuilder for BatchFnReaderBuilder {
        ...
        fn set_execution_state(&self, execution_state: &StreamingExecutionState) {
            *self.execution_state.lock() = Some(execution_state.clone());
        }
        ...
        fn build_file_reader(
            ...
            reader.execution_state = Some(self.execution_state.lock().as_ref().unwrap().clone());
