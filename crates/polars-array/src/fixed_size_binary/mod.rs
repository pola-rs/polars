...
mod tests {
    ...
    fn broadcasting_one_element() {
        ...
        assert_eq!(iter.next(), Some([7u8; 32].as_slice()));
        assert_eq!(iter.nth(999_999_997), Some([7u8; 32].as_slice()));
        assert_eq!(iter.next_back(), Some([7u8; 32].as_slice()));
        ...
        assert_eq!(
            PlFixedSizeBinaryArray::new_empty(2)
