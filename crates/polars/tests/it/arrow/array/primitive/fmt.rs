...
fn debug_timestamp_tz_ns() {
    ...
    assert_eq!(
        format!("{array:?}"),
        "Timestamp(Nanosecond, Some(\"+02:00\"))[1970-01-01T02:00:00.000000001+02:00[+02:00], None, 1970-01-01T02:00:00.000000002+02:00[+02:00]]"
    );
}
...
fn debug_timestamp_tz1_ns() {
    ...
    assert_eq!(
        format!("{array:?}"),
        "Timestamp(Nanosecond, Some(\"Europe/Lisbon\"))[1970-01-01T01:00:00.000000001+01:00[Europe/Lisbon], None, 1970-01-01T01:00:00.000000002+01:00[Europe/Lisbon]]"
    );
}
