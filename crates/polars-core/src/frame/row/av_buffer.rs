...
impl<'a> AnyValueBuffer<'a> {
    ...
    pub fn add(&mut self, val: AnyValue<'a>) -> Option<()> {
        ...
        match (self, val) {
            ...
            #[cfg(feature = "dtype-date")]
            (Date(builder), val) if val.is_primitive_numeric() => builder.append_value(val.extract()?),
            #[cfg(feature = "dtype-datetime")]
            ...
            #[cfg(feature = "dtype-duration")]
            (Duration(builder, _), val) if val.is_primitive_numeric() => builder.append_value(val.extract()?),
            #[cfg(feature = "dtype-time")]
            (Time(builder), AnyValue::Time(v)) => builder.append_value(v),
            #[cfg(feature = "dtype-time")]
            (Time(builder), AnyValue::Null) => builder.append_null(),
            #[cfg(feature = "dtype-time")]
            (Time(builder), val) if val.is_primitive_numeric() => builder.append_value(val.extract()?),
