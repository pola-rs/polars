...
#[cfg(feature = "dtype-duration")]
impl<T: AsRef<[SignedDuration]>> NamedFrom<T, [SignedDuration]> for DurationChunked {
    fn new(name: PlSmallStr, v: T) -> Self {
...
#[cfg(feature = "dtype-duration")]
impl<T: AsRef<[SignedDuration]>> NamedFrom<T, [SignedDuration]> for Series {
    fn new(name: PlSmallStr, v: T) -> Self {
...
#[cfg(feature = "dtype-duration")]
impl<T: AsRef<[Option<SignedDuration>]>> NamedFrom<T, [Option<SignedDuration>]>
    for DurationChunked
{
    fn new(name: PlSmallStr, v: T) -> Self {
...
#[cfg(feature = "dtype-duration")]
impl<T: AsRef<[Option<SignedDuration>]>> NamedFrom<T, [Option<SignedDuration>]> for Series {
    fn new(name: PlSmallStr, v: T) -> Self {
        DurationChunked::new(name, v).into_series()
    }
}
...
mod test {
    ...
    fn test_temporal_df_construction() {
        ...
        let _df = df![
            ...
            "duration" => [SignedDuration::from_secs(10)],
            "optional_duration" => [Some(SignedDuration::from_secs(10))],
        ]
        .unwrap();
    }
