//! The filter kernels over the Arrow arrays of `polars-arrow`.
//!
//! These read one slot per element throughout; the kernels of `polars-array` sit in
//! [`pl_array`](super::pl_array) and cross over to these once a chunk is known to be laid out
//! that way.
