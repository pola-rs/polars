...
use binview_to::utf8_binview_to_primitive_dyn;
    ...
    match (from_type, to_type) {
        ...
        (Utf8View, _) => {
            ...
            match to_type {
                ...
                UInt8 => utf8_binview_to_primitive_dyn::<u8>(&arr.to_binview(), to_type, options),
                UInt16 => utf8_binview_to_primitive_dyn::<u16>(&arr.to_binview(), to_type, options),
                UInt32 => utf8_binview_to_primitive_dyn::<u32>(&arr.to_binview(), to_type, options),
                UInt64 => utf8_binview_to_primitive_dyn::<u64>(&arr.to_binview(), to_type, options),
                Int8 => utf8_binview_to_primitive_dyn::<i8>(&arr.to_binview(), to_type, options),
                Int16 => utf8_binview_to_primitive_dyn::<i16>(&arr.to_binview(), to_type, options),
