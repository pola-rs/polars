...
pub fn function_expr_to_udf(func: IRRangeFunction) -> SpecialEq<Arc<dyn ColumnsUdf>> {
    ...
    match func {
        ...
        DateRange {
            ...
            map_as_slice!(datetime_range::date_range, interval.unwrap(), closed)
        },
        #[cfg(feature = "dtype-date")]
        DateRanges {
            interval,
            ...
            map_as_slice!(datetime_range::date_ranges, interval.unwrap(), closed)
        },
        #[cfg(feature = "dtype-datetime")]
        DatetimeRange {
            interval,
            ...
            map_as_slice!(datetime_range::datetime_range, interval.unwrap(), closed)
        },
        #[cfg(feature = "dtype-datetime")]
        DatetimeRanges {
            interval,
            ...
            map_as_slice!(datetime_range::datetime_ranges, interval.unwrap(), closed)
        },
        #[cfg(feature = "dtype-time")]
