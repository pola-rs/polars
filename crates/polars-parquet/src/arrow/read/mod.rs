...
pub trait PagesIter<'mmap>:
    FallibleStreamingIterator<Item = Page<'mmap>, Error = ParquetError> + Send + Sync
{
}

impl<'mmap, I: FallibleStreamingIterator<Item = Page<'mmap>, Error = ParquetError> + Send + Sync>
    PagesIter<'mmap> for I
{
}
