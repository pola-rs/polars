...
use super::{get_field_columns, get_page_iterator, PageFilter, PageReader, ReadSliced};
...
pub fn get_column_iterator<'a, R: ReadSliced<'a>>(
    reader: R,
...
pub struct ColumnIterator<'a, R: ReadSliced<'a>> {
    reader: Option<R>,
...
impl<'a, R: ReadSliced<'a>> ColumnIterator<'a, R> {
...
impl<'a, R: ReadSliced<'a>> MutStreamingIterator for ColumnIterator<'a, R> {
