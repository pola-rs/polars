...
switch (platform) {
  case 'android':
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'polars-js.android-arm64.node'))
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.android-arm64.node')
          } else {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'polars-js.android-arm-eabi.node'))
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.android-arm-eabi.node')
          } else {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'polars-js.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.win32-x64-msvc.node')
          } else {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'polars-js.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.win32-ia32-msvc.node')
          } else {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'polars-js.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.win32-arm64-msvc.node')
          } else {
  ...
  case 'darwin':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'polars-js.darwin-x64.node'))
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.darwin-x64.node')
          } else {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'polars-js.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.darwin-arm64.node')
          } else {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(join(__dirname, 'polars-js.freebsd-x64.node'))
    try {
      if (localFileExisted) {
        nativeBinding = require('./polars-js.freebsd-x64.node')
      } else {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'polars-js.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./polars-js.linux-x64-musl.node')
            } else {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'polars-js.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./polars-js.linux-x64-gnu.node')
            } else {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'polars-js.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./polars-js.linux-arm64-musl.node')
            } else {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'polars-js.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./polars-js.linux-arm64-gnu.node')
            } else {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'polars-js.linux-arm-gnueabihf.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./polars-js.linux-arm-gnueabihf.node')
          } else {
...
module.exports.PySeries = PySeries
