...
export interface LazyDataFrame extends Serialize {
  ...
  /**
    ...
    ```
   */
  groupByRolling(opts: {indexColumn: string, by: ColumnsOrExpr, period: string, offset?: string, closed?: "left" | "right" | "both" | "none"}): LazyGroupBy
  /**
...
export const _LazyDataFrame = (_ldf: any): LazyDataFrame => {
  ...
  return {
    ...
    groupByRolling({indexColumn, by, period, offset, closed}) {
      ...
      const lgb = _ldf.groupbyRolling(indexColumn, period, offset, closed);
