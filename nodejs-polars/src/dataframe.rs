...
pub(crate) fn add(cx: CallContext) -> JsResult<JsExternal> {
  let params = get_params(&cx)?;
  let df = params.get_df(&cx, "_df")?;
  let s = params.get_series(&cx, "_series")?;
...
#[js_function(1)]
pub fn vstack(cx: CallContext) -> JsResult<Either<JsExternal, JsUndefined>> {
  let params = get_params(&cx)?;
  let df = params.get_df_mut(&cx, "_df")?;
  let other = params.get_df(&cx, "other")?;
  let in_place = params.get_as::<bool>("in_place")?;
  ...
  if in_place {
    df.df.vstack_mut(&other.df).map_err(JsPolarsEr::from)?;
    cx.env.get_undefined().map(Either::B)
  } else {
...
// #[js_function(1)]
// pub fn hmean(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
// #[js_function(1)]
// pub fn hmax(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
// #[js_function(1)]
// pub fn hmin(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
// #[js_function(1)]
// pub fn hsum(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
...
// }
// #[js_function(1)]
// pub fn apply(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
// #[js_function(1)]
// pub fn shrink_to_fit(cx: CallContext) -> JsResult<JsExternal> {
//   let params = get_params(&cx)?;
//   let df = params.get_df(&cx, "_df")?;
//   todo!()
// }
