...
impl JsSeries {
    pub fn to_object(env: &napi::Env) -> JsResult<JsObject> {
        ...
        series.define_properties(&[
            ...
            napi::Property::new(env, "extend_constant")?.with_method(extend_constant),
            ...
            napi::Property::new(env, "get_struct")?.with_method(get_struct),
            ...
            napi::Property::new(env, "strftime")?.with_method(strftime),
            napi::Property::new(env, "struct_fields")?.with_method(struct_fields),
            napi::Property::new(env, "struct_to_frame")?.with_method(struct_to_frame),
