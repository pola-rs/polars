...
#[cfg(feature = "private")]
pub struct AmortizedListIter<'a, I: Iterator<Item = Option<ArrayRef>>> {
...
#[cfg(feature = "private")]
unsafe impl<'a, I: Iterator<Item = Option<ArrayRef>>> TrustedLen for AmortizedListIter<'a, I> {}
...
impl ListChunked {
    ...
    /// that Series.
    #[cfg(feature = "private")]
    pub fn amortized_iter(&self) -> AmortizedListIter<impl Iterator<Item = Option<ArrayRef>> + '_> {
