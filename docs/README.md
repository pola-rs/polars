...
[PR #18773](https://github.com/pola-rs/polars/pull/18773) we introduced this split to fix the docs
server live reloading. If everything is in one folder `docs`, the docs server will watch the folder
`docs`. When you make one change the docs server live reloads and rebuilds the docs. This triggers
scripts that build asset files, which change the folder `docs`, leading to an infinite reloading
loop.
