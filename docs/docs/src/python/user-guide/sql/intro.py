...
with open("docs/docs-res/data/products_categories.json", "w") as temp_file:
...
with open("docs/docs-res/data/products_masterdata.csv", "w") as temp_file:
...
with pl.SQLContext(
    products_masterdata=pl.scan_csv("docs/docs-res/data/products_masterdata.csv"),
    products_categories=pl.scan_ndjson("docs/docs-res/data/products_categories.json"),
...
os.remove("docs/docs-res/data/products_categories.json")
os.remove("docs/docs-res/data/products_masterdata.csv")
