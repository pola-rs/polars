...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let df = df!(
        ...
        "date" => date_range(
            "date".into(),
            NaiveDate::from_ymd_opt(2022, 1, 1).unwrap().and_hms_opt(0, 0, 0),
            NaiveDate::from_ymd_opt(2022, 1, 3).unwrap().and_hms_opt(0, 0, 0),
        ...
        "logged_at" => date_range(
            "logged_at".into(),
            NaiveDate::from_ymd_opt(2022, 1, 1).unwrap().and_hms_opt(0, 0, 0),
            NaiveDate::from_ymd_opt(2022, 1, 1).unwrap().and_hms_opt(0, 0, 2),
