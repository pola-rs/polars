...
During review, some of our maintainers will use [_conventional comments_](https://conventionalcomments.org)
in their reviews. The comment labels (like **issue**: or **nit:**) have specific
[meanings](https://conventionalcomments.org/#labels).
...
- _Python:_ Update the version number in
  [`py-polars/Cargo.toml`](https://github.com/pola-rs/polars/blob/main/py-polars/runtime/template/Cargo.toml#L4)
