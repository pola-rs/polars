## 0.5.0 (latest) <small>- 3 June 2026</small>

- `polars` [1.41.2](https://github.com/pola-rs/polars/releases/tag/py-1.40.1)
- `polars-cloud` [0.8.0](https://github.com/pola-rs/polars-cloud-client/releases/tag/client-0.7.0)
