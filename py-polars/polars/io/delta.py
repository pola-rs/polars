...
def read_delta(
    ...
    *,
    ...
    schema
        Specify schema to use when reading. It may be useful when
        reading data that was generated by other engines (e.g. Spark) that did not use
        correct data type for specific columns (e.g. Timestamp nanoseconds)
    rechunk
...
def scan_delta(
    ...
    * abfs[s]://<container>/<path>
    ...
    polars_schema = schema or from_arrow(pa.Table.from_pylist([], delta_schema)).schema  # type: ignore[union-attr]
