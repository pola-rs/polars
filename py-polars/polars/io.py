...
def read_csv(
    ...
    pyarrow_parse_opts: dict[str, Any] | None = None,
    pyarrow_read_opts: dict[str, Any] | None = None,
    pyarrow_conversion_opts: dict[str, Any] | None = None,
    ...
    pyarrow_parse_opts
        Extra options for parsing when using pyarrow
    pyarrow_read_opts
        Extra options for reading when using pyarrow
    pyarrow_conversion_opts
        Extra options for conversion when using pyarrow
    storage_options
    ...
    pyarrow_conversion_opts = pyarrow_conversion_opts or {}
    pyarrow_parse_opts = pyarrow_parse_opts or {}
    pyarrow_read_opts = pyarrow_read_opts or {}
    ...
    if not use_pyarrow and any(pyarrow_args):
        invalid_args = [arg_map for arg_map in pyarrow_args if arg_map]
        warnings.warn(
            f"You provided values for {invalid_args} but you are not using pyarrow."
            "This arguments will be ignored",
