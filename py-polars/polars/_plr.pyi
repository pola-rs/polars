...
class PySeries:
    # map
    def map_elements(
        self, function: Any, return_dtype: Any | None = None, skip_nulls: bool = False
    ) -> Self: ...

    # general
    def struct_unnest(self) -> PyDataFrame: ...
    def struct_fields(self) -> Sequence[str]: ...
    ...
    def cat_to_local(self) -> Self: ...
    def estimated_size(self) -> int: ...
    def get_object(self, index: int) -> Any: ...
    def reshape(self, dims: Sequence[int]) -> Self: ...
    def get_fmt(self, index: int, str_len_limit: int) -> str: ...
    @overload
    def rechunk(self, in_place: Literal[True]) -> None: ...
    @overload
    def rechunk(self, in_place: Literal[False]) -> Self: ...
    def get_index(self, index: int) -> Any: ...
    def get_index_signed(self, index: int) -> Any: ...
    def bitand(self, other: PySeries) -> Self: ...
    def bitor(self, other: PySeries) -> Self: ...
    def bitxor(self, other: PySeries) -> Self: ...
    def chunk_lengths(self) -> Sequence[int]: ...
    def name(self) -> str: ...
    def rename(self, name: str) -> None: ...
    def dtype(self) -> Any: ...
    def set_sorted_flag(self, descending: bool) -> Self: ...
    ...
    def filter(self, filter: PySeries) -> Self: ...
    def sort(self, descending: bool, nulls_last: bool, multithreaded: bool) -> Self: ...
    def gather_with_series(self, indices: PySeries) -> Self: ...
    ...
    def clone(self) -> Self: ...
    def zip_with(self, mask: PySeries, other: PySeries) -> Self: ...
    def to_dummies(
        self,
        separator: str | None = ...,
        drop_first: bool = ...,
    ...
    def get_list(self, index: int) -> Self | None: ...
    ...
    def cast(self, dtype: Any, strict: bool, wrap_numerical: bool) -> Self: ...
    def get_chunks(self) -> Sequence[Any]: ...
    ...
    def __xor__(self, other: PySeries) -> Self: ...
    def __neg__(self) -> Self: ...
    def __invert__(self) -> Self: ...
    def __eq__(self, other: object) -> PySeries: ...
    def __ne__(self, other: object) -> PySeries: ...
    def __lt__(self, other: PySeries | Any) -> PySeries: ...
    def __le__(self, other: PySeries | Any) -> PySeries: ...
    def __gt__(self, other: PySeries | Any) -> PySeries: ...
    def __ge__(self, other: PySeries | Any) -> PySeries: ...
    def __getitem__(self, item: int | slice | PySeries) -> Any | PySeries: ...
    def __setitem__(self, key: int | slice | PySeries, value: Any) -> None: ...
...
class PyDataFrame:
    ...
    def estimated_size(self) -> int: ...
    def dtype_strings(self) -> Sequence[str]: ...
    def add(self, s: PySeries) -> Self: ...
    def sub(self, s: PySeries) -> Self: ...
    def mul(self, s: PySeries) -> Self: ...
    def div(self, s: PySeries) -> Self: ...
    def rem(self, s: PySeries) -> Self: ...
    def add_df(self, s: Self) -> Self: ...
    def sub_df(self, s: Self) -> Self: ...
    def mul_df(self, s: Self) -> Self: ...
    def div_df(self, s: Self) -> Self: ...
    def rem_df(self, s: Self) -> Self: ...
    def sample_n(
    ...
    def as_str(self) -> str: ...
    def get_columns(self) -> Sequence[PySeries]: ...
    ...
    def hstack(self, columns: Sequence[PySeries]) -> Self: ...
    def hstack_mut(self, columns: Sequence[PySeries]) -> None: ...
    def vstack(self, other: Self) -> Self: ...
    def vstack_mut(self, other: Self) -> None: ...
    ...
    def select(self, columns: Sequence[str]) -> Self: ...
    def gather(self, indices: Sequence[int]) -> Self: ...
    def gather_with_series(self, indices: PySeries) -> Self: ...
    ...
    @overload
    def slice(self, offset: int) -> Self: ...
    def head(self, n: int) -> Self: ...
    def tail(self, n: int) -> Self: ...
    def is_unique(self) -> PySeries: ...
    def is_duplicated(self) -> PySeries: ...
    def equals(self, other: Self, null_equal: bool) -> bool: ...
    def with_row_index(self, name: str, offset: int | None = ...) -> Self: ...
    def _to_metadata(self) -> Self: ...
    ...
    def transpose(
        self, keep_names_as: str | None, column_names: str | Sequence[str]
    ) -> Self: ...
    def upsample(
        self,
        by: Sequence[str],
    ...
    def _import_columns(self, location: int, width: int) -> Self: ...
    ...
    def from_dicts(
        data: Any,
        schema: Any | None = None,
        schema_overrides: Any | None = None,
        strict: bool = True,
        infer_schema_length: int | None = None,
    ) -> PyDataFrame: ...
    @staticmethod
    ...
    def row_tuples(self) -> Sequence[tuple[Any, ...]]: ...
    def to_arrow(self, compat_level: Any) -> Sequence[Any]: ...
    ...
    def __eq__(self, other: object) -> PySeries: ...
    def __ne__(self, other: object) -> PySeries: ...
    def __add__(self, other: PySeries | Self) -> Self: ...
    def __sub__(self, other: PySeries | Self) -> Self: ...
    def __mul__(self, other: PySeries | Self) -> Self: ...
    def __truediv__(self, other: PySeries | Self) -> Self: ...
    def __mod__(self, other: PySeries | Self) -> Self: ...
    def __getitem__(self, item: str | Sequence[str]) -> PySeries | Self: ...
...
class PyLazyFrame:
    ...
    @staticmethod
    def new_from_dataset_object(dataset_object: Any) -> Self: ...
    @staticmethod
    ...
    def top_k(self, k: int, by: Sequence[PyExpr], reverse: Sequence[bool]) -> Self: ...
    def bottom_k(
        self, k: int, by: Sequence[PyExpr], reverse: Sequence[bool]
    ) -> Self: ...
    def cache(self) -> Self: ...
    def with_optimizations(self, optflags: PyOptFlags) -> Self: ...
    def profile(
        self, lambda_post_opt: Any | None = ...
    ) -> tuple[PyDataFrame, PyDataFrame]: ...
    def collect(
        self, engine: Any, lambda_post_opt: Any | None = ...
    ) -> PyDataFrame: ...
    ...
    def filter(self, predicate: PyExpr) -> Self: ...
    def remove(self, predicate: PyExpr) -> Self: ...
    def select(self, exprs: Sequence[PyExpr]) -> Self: ...
    def select_seq(self, exprs: Sequence[PyExpr]) -> Self: ...
    ...
    def with_context(self, contexts: Sequence[Self]) -> Self: ...
    def join_asof(
        self,
        other: Self,
        left_on: PyExpr,
    ...
    def join_where(
        self, other: Self, predicates: Sequence[PyExpr], suffix: str
    ) -> Self: ...
    def with_columns(self, exprs: Sequence[PyExpr]) -> Self: ...
    def with_columns_seq(self, exprs: Sequence[PyExpr]) -> Self: ...
    def match_to_schema(
        self,
        schema: Schema,
        missing_columns: Any,
    ...
    def shift(self, n: PyExpr, fill_value: PyExpr | None = None) -> Self: ...
    def fill_nan(self, fill_value: PyExpr) -> Self: ...
    def min(self) -> Self: ...
    def max(self) -> Self: ...
    def sum(self) -> Self: ...
    def mean(self) -> Self: ...
    ...
    def quantile(self, quantile: PyExpr, interpolation: QuantileMethod) -> Self: ...
    def explode(self, subset: PySelector) -> Self: ...
    def null_count(self) -> Self: ...
    def unique(
        self,
        maintain_order: bool,
    ...
    def drop_nans(self, subset: PySelector | None) -> Self: ...
    def drop_nulls(self, subset: PySelector | None) -> Self: ...
    def slice(self, offset: int, len: int | None = None) -> Self: ...
    def tail(self, n: int) -> Self: ...
    def unpivot(
        self,
        on: PySelector,
    ...
    def with_row_index(self, name: str, offset: int | None = None) -> Self: ...
    def map_batches(
        self,
        function: Any,
        predicate_pushdown: bool,
    ...
    def drop(self, columns: PySelector) -> Self: ...
    def cast(self, dtypes: dict[str, DataType], strict: bool) -> Self: ...
    def cast_all(self, dtype: PyDataTypeExpr, strict: bool) -> Self: ...
    def clone(self) -> Self: ...
    def collect_schema(self) -> dict[str, Any]: ...
    def unnest(self, columns: PySelector) -> Self: ...
    def count(self) -> Self: ...
    def merge_sorted(self, other: Self, key: str) -> Self: ...
...
class PyExpr:
    ...
    @overload
    def search_sorted(
        self, element: PyExpr, side: Any, descending: bool = ...
    ) -> PyExpr: ...
    ...
    def meta_pop(self, schema: Schema | None = None) -> Sequence[PyExpr]: ...
    def meta_root_names(self) -> Sequence[str]: ...
...
def datetime(
    ...
    month: PyExpr,
    day: PyExpr,
    hour: PyExpr | None = None,
    minute: PyExpr | None = None,
    second: PyExpr | None = None,
    microsecond: PyExpr | None = None,
...
def duration(
    weeks: PyExpr | None = None,
    days: PyExpr | None = None,
    hours: PyExpr | None = None,
    minutes: PyExpr | None = None,
    seconds: PyExpr | None = None,
    milliseconds: PyExpr | None = None,
    microseconds: PyExpr | None = None,
    nanoseconds: PyExpr | None = None,
    time_unit: TimeUnit = ...,  # Default set by Rust code
) -> PyExpr: ...
def fold(
    acc: PyExpr,
...
def set_float_precision(precision: int | None = None) -> None: ...
def get_float_precision() -> int | None: ...
def set_thousands_separator(sep: str | None = None) -> None: ...
def get_thousands_separator() -> str | None: ...
def set_decimal_separator(sep: str | None = None) -> None: ...
def get_decimal_separator() -> str | None: ...
def set_trim_decimal_zeros(trim: bool | None = None) -> None: ...
