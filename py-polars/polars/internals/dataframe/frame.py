...
class DataFrame:
    ...
    def remap(
        ...
        """
        Remap values in column according to remapping dictionary.

        Parameters
        ----------
        column
            Column on which to apply the mapping.
        remapping
            Mapping dictionary to use for remapping the values.
        default
            Value to use when original value was not found in remapping dictionary.
        new_column
            If set, write mapping to new column instead of overwriting
            original column.
        ...
        Keep the original column and add a new column with the results of the mapping.
        >>> df.remap(
        ...     column="country_code",
        ...     remapping=country_code_dict,
        ...     new_column="country_name",
        ... )
        shape: (4, 3)
        ┌────────┬──────────────┬───────────────┐
        │ row_nr ┆ country_code ┆ country_name  │
        │ ---    ┆ ---          ┆ ---           │
        │ u32    ┆ str          ┆ str           │
        ╞════════╪══════════════╪═══════════════╡
        │ 0      ┆ FR           ┆ France        │
