...
from polars.datatypes import UInt32, is_polars_dtype, py_type_to_dtype
from polars.dependencies import _check_for_numpy
from polars.dependencies import numpy as np
from polars.exceptions import PolarsInefficientApplyWarning
from polars.expr import operations
...
class Expr:
    ...
    def map_dict(
        ...
        *,
        ...
        """
        return operations.map_dict(
            self, remapping, default=default, return_dtype=return_dtype
        )
