...
def test_list_explode_on_non_list_raises_25649() -> None:
    """Test that list.explode on a non-list column raises during schema collection."""
    ...
    with pytest.raises(
        ...
        lf.select(pl.col("a").list.explode()).collect_schema()
