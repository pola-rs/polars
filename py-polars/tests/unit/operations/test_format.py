    ...
    expected = pl.DataFrame(
        {
            ...
            "d": [None if j is None else f"abc {i} {j}" for i, j in zip(a, b, strict=True)],
            "e": [None if j is None else f"{i} abc {j}" for i, j in zip(a, b, strict=True)],
            "f": [None if j is None else f"{i} {j} abc" for i, j in zip(a, b, strict=True)],
