...
def test_pycapsule_struct_vs_non_struct() -> None:
    ...
    result_int_array = pycapsule_to_frame(int_arrow_array)
    assert result_int_array.shape == (3, 1)
    ...
    result_int_stream = pycapsule_to_frame(int_stream_only)
    assert result_int_stream.shape == (3, 1)
