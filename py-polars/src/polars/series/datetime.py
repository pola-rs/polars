...
class DateTimeNameSpace(_NamespaceSuggestMixin):
    ...
    def convert_time_zone(self, time_zone: str) -> Series:
        ...
        shape: (5, 2)
        ┌────────────────────────────────┬────────────────────────────────┐
        │ convert_to_new_york            ┆ replace_with_new_york          │
        │ ---                            ┆ ---                            │
        │ datetime[μs, America/New_York] ┆ datetime[μs, America/New_York] │
        ╞════════════════════════════════╪════════════════════════════════╡
        │ 2020-02-29 19:00:00 EST        ┆ 2020-03-01 00:00:00 EST        │
        │ 2020-03-31 20:00:00 EDT        ┆ 2020-04-01 00:00:00 EDT        │
        │ 2020-04-30 20:00:00 EDT        ┆ 2020-05-01 00:00:00 EDT        │
        │ 2020-05-31 20:00:00 EDT        ┆ 2020-06-01 00:00:00 EDT        │
        │ 2020-06-30 20:00:00 EDT        ┆ 2020-07-01 00:00:00 EDT        │
        └────────────────────────────────┴────────────────────────────────┘
        """
    ...
    def replace_time_zone(
        ...
        *,
        ...
        shape: (5, 2)
        ┌────────────────────────────────┬────────────────────────────────┐
        │ replace_with_new_york          ┆ convert_to_new_york            │
        │ ---                            ┆ ---                            │
        │ datetime[μs, America/New_York] ┆ datetime[μs, America/New_York] │
        ╞════════════════════════════════╪════════════════════════════════╡
        │ 2020-03-01 00:00:00 EST        ┆ 2020-02-29 19:00:00 EST        │
        │ 2020-04-01 00:00:00 EDT        ┆ 2020-03-31 20:00:00 EDT        │
        │ 2020-05-01 00:00:00 EDT        ┆ 2020-04-30 20:00:00 EDT        │
        │ 2020-06-01 00:00:00 EDT        ┆ 2020-05-31 20:00:00 EDT        │
        │ 2020-07-01 00:00:00 EDT        ┆ 2020-06-30 20:00:00 EDT        │
        └────────────────────────────────┴────────────────────────────────┘
