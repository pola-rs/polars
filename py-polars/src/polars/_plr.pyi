...
class PyLazyFrame:
    ...
    @staticmethod
    def placeholder(name: str, schema: Any) -> PyLazyFrame: ...
    def bind(self, bindings: dict[str, PyLazyFrame]) -> PyLazyFrame: ...
    def optimize_template(self) -> PyOptimizedTemplate: ...
...
class PyOptimizedTemplate:
    def bind_and_collect(self, bindings: dict[str, PyLazyFrame]) -> PyDataFrame: ...
    def bind(self, bindings: dict[str, PyLazyFrame]) -> PyLazyFrame: ...
