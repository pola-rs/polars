...
class PySeries:
    ...
    @staticmethod
    def new_uuid(name: str, values: Any, strict: bool) -> PySeries: ...
    @staticmethod
...
class PyExpr:
    ...
    # uuid
    def uuid_generate_v4(self) -> PyExpr: ...
    def uuid_generate_v7(self) -> PyExpr: ...
    def uuid_version(self) -> PyExpr: ...
    def uuid_timestamp(self, strict: bool) -> PyExpr: ...
