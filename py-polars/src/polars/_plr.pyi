...
class PyDataFrame:
    ...
    def to_numpy(self, order: IndexOrder, writable: bool, allow_copy: bool) -> Any: ...
    def __arrow_c_stream__(self, requested_schema: Any | None) -> Any: ...
    ...
    def write_pcap(self, py_f: Any) -> None: ...
...
class PyPcapReader:
    def __init__(self, py_f: Any, n_rows: int | None) -> None: ...
    def schema(self) -> Any: ...
    def next_batch(self, batch_size: int) -> PyDataFrame | None: ...
...
def sum_horizontal(exprs: Sequence[PyExpr]) -> PyExpr: ...
def mean_horizontal(exprs: Sequence[PyExpr]) -> PyExpr: ...
...
def concat_lf(
    lfs: Sequence[PyLazyFrame], rechunk: bool, parallel: bool
) -> PyLazyFrame: ...
def concat_lf_diagonal(
    lfs: Sequence[PyLazyFrame], rechunk: bool, parallel: bool
) -> PyLazyFrame: ...
def concat_lf_horizontal(lfs: Sequence[PyLazyFrame]) -> PyLazyFrame: ...
def concat_expr(exprs: Sequence[PyExpr], rechunk: bool) -> PyExpr: ...

# functions.lazy
def col(name: str) -> PyExpr: ...
def lit(value: Any, allow_object: bool) -> PyExpr: ...
def len() -> PyExpr: ...
def arg_where(condition: PyExpr) -> PyExpr: ...
def pearson_corr(a: PyExpr, b: PyExpr, ddof: int) -> PyExpr: ...
def spearman_rank_corr(
    a: PyExpr, b: PyExpr, ddof: int, propagate_nans: bool
) -> PyExpr: ...
...
def fold(acc: PyExpr, function: Any, exprs: Sequence[PyExpr]) -> PyExpr: ...
def reduce(function: Any, exprs: Sequence[PyExpr]) -> PyExpr: ...
def cum_fold(acc: PyExpr, function: Any, exprs: Sequence[PyExpr]) -> PyExpr: ...
def cum_reduce(function: Any, exprs: Sequence[PyExpr]) -> PyExpr: ...
def arctan2(y: PyExpr, x: PyExpr) -> PyExpr: ...
def arg_sort_by(
    by: Sequence[PyExpr], descending: Sequence[bool], nulls_last: Sequence[bool]
) -> PyExpr: ...
def collect_all(lfs: Sequence[PyLazyFrame], engine: Any) -> list[PyDataFrame]: ...
def collect_all_with_callback(
    lfs: Sequence[PyLazyFrame], engine: Any, lambda_func: Any
) -> None: ...
def explain_all(lfs: Sequence[PyLazyFrame], optimized: bool) -> str: ...
def coalesce(exprs: Sequence[PyExpr]) -> PyExpr: ...
def rolling_cov(a: PyExpr, b: PyExpr, window_size: int, ddof: int) -> PyExpr: ...
def rolling_corr(a: PyExpr, b: PyExpr, window_size: int, ddof: int) -> PyExpr: ...
def sql_expr(sql: str) -> PyExpr: ...
def business_day_count(
    start: PyExpr, end: PyExpr, week_mask: Sequence[bool], holidays: Sequence[int]
) -> PyExpr: ...
def datetime(
    year: PyExpr,
    month: PyExpr,
...
def concat_list(exprs: Sequence[PyExpr]) -> PyExpr: ...
def concat_arr(exprs: Sequence[PyExpr]) -> PyExpr: ...
def as_struct(exprs: Sequence[PyExpr]) -> PyExpr: ...
def concat_str(exprs: Sequence[PyExpr], separator: str, ignore_nulls: bool) -> PyExpr: ...
def repeat(value: PyExpr, n: PyExpr, dtype: DataType | None) -> PyExpr: ...
def field(name: str) -> PyExpr: ...
def element() -> PyExpr: ...
