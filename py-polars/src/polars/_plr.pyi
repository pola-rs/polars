...
class PySeries:
    ...
    def struct_fields(self) -> builtins.list[str]: ...
    ...
    def chunk_lengths(self) -> builtins.list[int]: ...
    def name(self) -> str: ...
    ...
    def get_chunks(self) -> builtins.list[Any]: ...
    ...
    # export
    def to_list(self) -> builtins.list[Any]: ...
...
class PyDataFrame:
    ...
    def estimated_size(self) -> int: ...
    def dtype_strings(self) -> builtins.list[str]: ...
    ...
    def row_tuples(self) -> builtins.list[tuple[Any, ...]]: ...
    def to_arrow(self, compat_level: Any) -> builtins.list[Any]: ...
    def to_pandas(self) -> builtins.list[Any]: ...
    def __arrow_c_stream__(self, requested_schema: Any | None) -> Any: ...
...
class PyLazyFrame:
    ...
    def unique(
        self,
        maintain_order: bool,
        subset: builtins.list[PyExpr] | None,
    ...
    def hint_sorted(
        ...
        descending: builtins.list[bool],
        nulls_last: builtins.list[bool],
    ) -> PyLazyFrame: ...
...
class PyExpr:
    ...
    def meta_pop(self, schema: Schema | None = None) -> builtins.list[PyExpr]: ...
    def meta_root_names(self) -> builtins.list[str]: ...
    ...
    @staticmethod
    def str_format(f_string: str, exprs: builtins.list[PyExpr]) -> PyExpr: ...
...
def _bench_parquet_metadata_bincode_size(
    path: str, projection: builtins.list[str] | None, predicate: builtins.list[str]
) -> int: ...
def _parquet_metadata_pruned_json(
    path: str, projection: builtins.list[str], predicate: builtins.list[str]
) -> str: ...
...
class PyLazyGroupBy:
    def agg(self, aggs: builtins.list[PyExpr]) -> PyLazyFrame: ...
    def head(self, n: int) -> PyLazyFrame: ...
    def tail(self, n: int) -> PyLazyFrame: ...
    def having(self, predicates: builtins.list[PyExpr]) -> PyLazyGroupBy: ...
    def map_groups(
...
class PyCatalogClient:
    ...
    def list_catalogs(self) -> builtins.list[Any]: ...
    def list_namespaces(self, catalog_name: str) -> builtins.list[Any]: ...
    def list_tables(self, catalog_name: str, namespace: str) -> builtins.list[Any]: ...
    def get_table_info(
...
class PySQLContext:
    ...
    def get_tables(self) -> builtins.list[str]: ...
...
def _known_timezones() -> builtins.list[str]: ...
...
class NodeTraverser:
    def get_exprs(self) -> builtins.list[PyExprIR]: ...
    def get_inputs(self) -> builtins.list[int]: ...
    ...
    def add_expressions(
        self, expressions: builtins.list[PyExpr]
    ) -> tuple[builtins.list[int], int]: ...
    def set_expr_mapping(self, mapping: builtins.list[int]) -> None: ...
