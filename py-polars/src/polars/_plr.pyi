...
def concat_lf_horizontal(lfs: Any, parallel: bool, strict: bool) -> PyLazyFrame: ...
...
def rolling_cov(
    a: PyExpr, b: PyExpr, window_size: int, min_periods: int, ddof: int
) -> PyExpr: ...
def rolling_corr(
    a: PyExpr, b: PyExpr, window_size: int, min_periods: int, ddof: int
) -> PyExpr: ...
...
def repeat(value: PyExpr, n: PyExpr, dtype: Any | None) -> PyExpr: ...
def field(name: Sequence[str]) -> PyExpr: ...
def element() -> PyExpr: ...
...
class PySQLContext:
    ...
    def find_all_tables(self, query: str) -> list[str]: ...
