...
def _parquet_encrypt_key_locally(
    plaintext_key: bytes, wrapping_key: bytes, aad: bytes
) -> bytes: ...
def _parquet_decrypt_key_locally(
    encrypted_key: bytes, wrapping_key: bytes, aad: bytes
) -> bytes: ...
