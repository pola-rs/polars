...
class PyExpr:
    ...
    def meta_is_scalar_literal(self) -> bool: ...
...
def eager_repeat(value: PyExpr, n: PyExpr, dtype: Any | None = None) -> PySeries: ...
...
def set_query_monitoring(enable: bool, workspace: str | None = None) -> None: ...
