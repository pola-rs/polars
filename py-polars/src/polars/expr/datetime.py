...
class ExprDateTimeNameSpace(_NamespaceSuggestMixin):
    ...
    def truncate(self, every: str | dt.timedelta | Expr) -> Expr:
        ...
        │ 2001-01-01T00:10:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-01T00:20:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-01T00:30:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T00:40:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T00:50:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T01:00:00 ┆ 2001-01-01T01:00:00 │
        └─────────────────────┴─────────────────────┘
        """
    ...
    def round(self, every: str | dt.timedelta | IntoExprColumn) -> Expr:
        ...
        ╞═════════════════════╪═════════════════════╡
        │ 2001-01-01T00:00:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-01T03:45:00 ┆ 2001-01-01T04:00:00 │
        │ 2001-01-01T07:30:00 ┆ 2001-01-01T08:00:00 │
        │ 2001-01-01T11:15:00 ┆ 2001-01-01T11:00:00 │
        │ 2001-01-01T15:00:00 ┆ 2001-01-01T15:00:00 │
        │ 2001-01-01T18:45:00 ┆ 2001-01-01T19:00:00 │
        │ 2001-01-01T22:30:00 ┆ 2001-01-01T23:00:00 │
        └─────────────────────┴─────────────────────┘
        ...
        │ 2001-01-01T00:00:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-01T00:10:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-01T00:20:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T00:30:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T00:40:00 ┆ 2001-01-01T00:30:00 │
        │ 2001-01-01T00:50:00 ┆ 2001-01-01T01:00:00 │
        │ 2001-01-01T01:00:00 ┆ 2001-01-01T01:00:00 │
        └─────────────────────┴─────────────────────┘
        """
        if isinstance(every, dt.timedelta):
    ...
    def combine(self, time: dt.time | Expr, time_unit: TimeUnit = "us") -> Expr:
        ...
        ╞═════════════════════╪════════════╪══════════════╡
        │ 2022-12-31T10:30:45 ┆ 2022-10-10 ┆ 01:02:03.456 │
        │ 2023-07-05T23:59:59 ┆ 2022-07-05 ┆ 07:08:09.101 │
        └─────────────────────┴────────────┴──────────────┘
        >>> df.select(
        ...     [
        ...
        ╞═════════════════════════╪═════════════════════════╪═════════════════════╡
        │ 2022-12-31T01:02:03.456 ┆ 2022-10-10T01:02:03.456 ┆ 2022-10-10T04:05:06 │
        │ 2023-07-05T07:08:09.101 ┆ 2022-07-05T07:08:09.101 ┆ 2022-07-05T04:05:06 │
        └─────────────────────────┴─────────────────────────┴─────────────────────┘
        """
    ...
    def to_string(self, format: str | None = None) -> Expr:
        ...
        * Duration dtype expressions cannot be formatted with `strftime`. Instead,
        ...
        │ 2077-07-05 ┆ 2040-12-30 16:40:50.000000 ┆ 00:00:00.0001   ┆ PT0S            │
        └────────────┴────────────────────────────┴─────────────────┴─────────────────┘
        ...
        │ datetime[μs]        ┆ str                   │
        ╞═════════════════════╪═══════════════════════╡
        │ 1980-08-10T00:10:20 ┆ 1980/08/10 (00.10.20) │
        │ 2010-10-20T08:25:35 ┆ 2010/10/20 (08.25.35) │
        │ 2040-12-30T16:40:50 ┆ 2040/12/30 (16.40.50) │
        └─────────────────────┴───────────────────────┘
    ...
    def strftime(self, format: str) -> Expr:
        ...
        │ datetime[μs]        ┆ str                 │
        ╞═════════════════════╪═════════════════════╡
        │ 2020-03-01T00:00:00 ┆ 2020/03/01 00:00:00 │
        │ 2020-04-01T00:00:00 ┆ 2020/04/01 00:00:00 │
        │ 2020-05-01T00:00:00 ┆ 2020/05/01 00:00:00 │
        └─────────────────────┴─────────────────────┘
        ...
        │ datetime[μs]        ┆ str       ┆ str        │
        ╞═════════════════════╪═══════════╪════════════╡
        │ 2020-03-01T00:00:00 ┆ Sunday    ┆ March      │
        │ 2020-04-01T00:00:00 ┆ Wednesday ┆ April      │
        │ 2020-05-01T00:00:00 ┆ Friday    ┆ May        │
        └─────────────────────┴───────────┴────────────┘
        """
    ...
    def time(self) -> Expr:
        ...
        │ datetime[μs]           ┆ time        │
        ╞════════════════════════╪═════════════╡
        │ 1978-01-01T01:01:01    ┆ 01:01:01    │
        │ 2024-10-13T05:30:14.5  ┆ 05:30:14.5  │
        │ 2065-01-01T10:20:30.06 ┆ 10:20:30.06 │
        └────────────────────────┴─────────────┘
        """
    ...
    def date(self) -> Expr:
        ...
        │ datetime[μs]           ┆ date       │
        ╞════════════════════════╪════════════╡
        │ 1978-01-01T01:01:01    ┆ 1978-01-01 │
        │ 2024-10-13T05:30:14.5  ┆ 2024-10-13 │
        │ 2065-01-01T10:20:30.06 ┆ 2065-01-01 │
        └────────────────────────┴────────────┘
        """
    ...
    def hour(self) -> Expr:
        ...
        ╞════════════════════════╪══════╪════════╪════════╪═════════════╡
        │ 1978-01-01T01:01:01    ┆ 1    ┆ 1      ┆ 1      ┆ 0           │
        │ 2024-10-13T05:30:14.5  ┆ 5    ┆ 30     ┆ 14     ┆ 500         │
        │ 2065-01-01T10:20:30.06 ┆ 10   ┆ 20     ┆ 30     ┆ 60          │
        └────────────────────────┴──────┴────────┴────────┴─────────────┘
        """
    ...
    def second(self, *, fractional: bool = False) -> Expr:
        ...
        ╞════════════════════════╪══════╪════════╪════════╡
        │ 1978-01-01T01:01:01    ┆ 1    ┆ 1      ┆ 1      │
        │ 2024-10-13T05:30:14.5  ┆ 5    ┆ 30     ┆ 14     │
        │ 2065-01-01T10:20:30.06 ┆ 10   ┆ 20     ┆ 30     │
        └────────────────────────┴──────┴────────┴────────┘
        >>> df.with_columns(
        ...     pl.col("datetime").dt.hour().alias("hour"),
        ...     pl.col("datetime").dt.minute().alias("minute"),
        ...
        ╞════════════════════════╪══════╪════════╪════════╡
        │ 1978-01-01T01:01:01    ┆ 1    ┆ 1      ┆ 1.0    │
        │ 2024-10-13T05:30:14.5  ┆ 5    ┆ 30     ┆ 14.5   │
        │ 2065-01-01T10:20:30.06 ┆ 10   ┆ 20     ┆ 30.06  │
        └────────────────────────┴──────┴────────┴────────┘
        """
    ...
    def microsecond(self) -> Expr:
        ...
        ╞════════════════════════╪══════╪════════╪════════╪═════════════╡
        │ 1978-01-01T01:01:01    ┆ 1    ┆ 1      ┆ 1      ┆ 0           │
        │ 2024-10-13T05:30:14.5  ┆ 5    ┆ 30     ┆ 14     ┆ 500000      │
        │ 2065-01-01T10:20:30.06 ┆ 10   ┆ 20     ┆ 30     ┆ 60000       │
        └────────────────────────┴──────┴────────┴────────┴─────────────┘
        """
    ...
    def nanosecond(self) -> Expr:
        ...
        ╞════════════════════════╪══════╪════════╪════════╪════════════╡
        │ 1978-01-01T01:01:01    ┆ 1    ┆ 1      ┆ 1      ┆ 0          │
        │ 2024-10-13T05:30:14.5  ┆ 5    ┆ 30     ┆ 14     ┆ 500000000  │
        │ 2065-01-01T10:20:30.06 ┆ 10   ┆ 20     ┆ 30     ┆ 60000000   │
        └────────────────────────┴──────┴────────┴────────┴────────────┘
        """
    ...
    def cast_time_unit(self, time_unit: TimeUnit) -> Expr:
        ...
        ╞═════════════════════╪═════════════════════╪═════════════════════╡
        │ 2001-01-01T00:00:00 ┆ 2001-01-01T00:00:00 ┆ 2001-01-01T00:00:00 │
        │ 2001-01-02T00:00:00 ┆ 2001-01-02T00:00:00 ┆ 2001-01-02T00:00:00 │
        │ 2001-01-03T00:00:00 ┆ 2001-01-03T00:00:00 ┆ 2001-01-03T00:00:00 │
        └─────────────────────┴─────────────────────┴─────────────────────┘
        """
    ...
    def convert_time_zone(self, time_zone: str) -> Expr:
        ...
        ╞═══════════════════════════╪═════════════════════════════╡
        │ 2020-03-01T00:00:00+00:00 ┆ 2020-03-01T00:00:00+00:00   │
        │ 2020-04-01T00:00:00+00:00 ┆ 2020-04-01T01:00:00+01:00   │
        │ 2020-05-01T00:00:00+00:00 ┆ 2020-05-01T01:00:00+01:00   │
        └───────────────────────────┴─────────────────────────────┘
        """
    ...
    def replace_time_zone(
        ...
        *,
        ...
        │ 2018-10-28T02:30:00 ┆ latest    ┆ 2018-10-28T02:30:00+01:00     │
    ...
    def total_days(self, *, fractional: bool = False) -> Expr:
        ...
        │ datetime[μs]        ┆ i64       │
        ╞═════════════════════╪═══════════╡
        │ 2020-03-01T00:00:00 ┆ null      │
        │ 2020-04-01T00:00:00 ┆ 31        │
        │ 2020-05-01T00:00:00 ┆ 30        │
        └─────────────────────┴───────────┘
        """
    ...
    def total_hours(self, *, fractional: bool = False) -> Expr:
        ...
        │ 2020-01-02T00:00:00 ┆ 24         │
        │ 2020-01-03T00:00:00 ┆ 24         │
        │ 2020-01-04T00:00:00 ┆ 24         │
        └─────────────────────┴────────────┘
        """
    ...
    def total_minutes(self, *, fractional: bool = False) -> Expr:
        ...
        ╞═════════════════════╪══════════════╡
        │ 2020-01-01T00:00:00 ┆ null         │
        │ 2020-01-02T00:00:00 ┆ 1440         │
        │ 2020-01-03T00:00:00 ┆ 1440         │
        │ 2020-01-04T00:00:00 ┆ 1440         │
        └─────────────────────┴──────────────┘
        """
    ...
    def total_seconds(self, *, fractional: bool = False) -> Expr:
        ...
        ╞═════════════════════╪══════════════╡
        │ 2020-01-01T00:00:00 ┆ null         │
        │ 2020-01-01T00:01:00 ┆ 60           │
        │ 2020-01-01T00:02:00 ┆ 60           │
        │ 2020-01-01T00:03:00 ┆ 60           │
        │ 2020-01-01T00:04:00 ┆ 60           │
        └─────────────────────┴──────────────┘
        """
    ...
    def total_milliseconds(self, *, fractional: bool = False) -> Expr:
        ...
        ╞═══════════════════════╪═══════════════════╡
        │ 2020-01-01T00:00:00   ┆ null              │
        │ 2020-01-01T00:00:00.2 ┆ 200               │
        │ 2020-01-01T00:00:00.4 ┆ 200               │
        │ 2020-01-01T00:00:00.6 ┆ 200               │
        │ 2020-01-01T00:00:00.8 ┆ 200               │
    ...
    def total_microseconds(self, *, fractional: bool = False) -> Expr:
        ...
        ╞═══════════════════════╪═══════════════════╡
        │ 2020-01-01T00:00:00   ┆ null              │
        │ 2020-01-01T00:00:00.2 ┆ 200000            │
        │ 2020-01-01T00:00:00.4 ┆ 200000            │
        │ 2020-01-01T00:00:00.6 ┆ 200000            │
        │ 2020-01-01T00:00:00.8 ┆ 200000            │
        │ 2020-01-01T00:00:01   ┆ 200000            │
        └───────────────────────┴───────────────────┘
        """
    ...
    def total_nanoseconds(self, *, fractional: bool = False) -> Expr:
        ...
        ╞═══════════════════════╪═══════════════════╡
        │ 2020-01-01T00:00:00   ┆ null              │
        │ 2020-01-01T00:00:00.2 ┆ 200000000         │
        │ 2020-01-01T00:00:00.4 ┆ 200000000         │
        │ 2020-01-01T00:00:00.6 ┆ 200000000         │
        │ 2020-01-01T00:00:00.8 ┆ 200000000         │
        │ 2020-01-01T00:00:01   ┆ 200000000         │
        └───────────────────────┴───────────────────┘
        """
    ...
    def offset_by(self, by: str | Expr) -> Expr:
        ...
        │ datetime[μs]        ┆ datetime[μs]        │
        ╞═════════════════════╪═════════════════════╡
        │ 2001-01-01T00:00:00 ┆ 1998-11-01T00:00:00 │
        │ 2002-01-01T00:00:00 ┆ 1999-11-01T00:00:00 │
        │ 2003-01-01T00:00:00 ┆ 2000-11-01T00:00:00 │
        │ 2004-01-01T00:00:00 ┆ 2001-11-01T00:00:00 │
        │ 2005-01-01T00:00:00 ┆ 2002-11-01T00:00:00 │
        │ 2006-01-01T00:00:00 ┆ 2003-11-01T00:00:00 │
        └─────────────────────┴─────────────────────┘
        ...
        ╞═════════════════════╪════════╪═════════════════════╡
        │ 2000-01-01T00:00:00 ┆ 1d     ┆ 2000-01-02T00:00:00 │
        │ 2001-01-01T00:00:00 ┆ 2d     ┆ 2001-01-03T00:00:00 │
        │ 2002-01-01T00:00:00 ┆ -1d    ┆ 2001-12-31T00:00:00 │
        │ 2003-01-01T00:00:00 ┆ 1mo    ┆ 2003-02-01T00:00:00 │
        │ 2004-01-01T00:00:00 ┆ null   ┆ null                │
        │ 2005-01-01T00:00:00 ┆ 1y     ┆ 2006-01-01T00:00:00 │
        └─────────────────────┴────────┴─────────────────────┘
        """
    ...
    def base_utc_offset(self) -> Expr:
        ...
        ╞════════════════════════════╪═════════════════╡
        │ 2011-12-29T00:00:00-10:00  ┆ -11h            │
        │ 2012-01-01T00:00:00+14:00  ┆ 13h             │
        └────────────────────────────┴─────────────────┘
        """
    ...
    def dst_offset(self) -> Expr:
        ...
        ╞═════════════════════════════╪══════════════╡
        │ 2020-10-25T00:00:00+01:00   ┆ 1h           │
        │ 2020-10-26T00:00:00+00:00   ┆ 0ms          │
        └─────────────────────────────┴──────────────┘
        """
